...
export class HbuilderXMessenger {
  ...
  constructor(
    ...
    this.onWebviewOrCore("setSelectedWorkspace", async (msg) => {
      const { workspacePath } = msg.data;
      console.log("[hbuilderx] Received setSelectedWorkspace:", workspacePath);
      this.ide.setSelectedWorkspace(workspacePath);
    });
  }
}
